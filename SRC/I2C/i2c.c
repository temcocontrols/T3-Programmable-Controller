 ...
 * Notes       :
 * $Log: i2c.c,v $
 * Revision 1.0  2009-01-05 14:03:31+08  wong
 * Initial revision
 *
...
/* STATIC VARIABLE DECLARATIONS */
 U8_T	 	i2cCtrl = 0;
 U8_T	 	i2cEndCond = 0;
 U8_T	 	i2cActF = 0;	// indicate the condition of a transfer
 U16_T 	i2cDataLen = 0;	// The I2cPktLen includes address and data
 U16_T 	i2cDataLenCnt = 0;	// Packet's counter of transferring 
 U8_T	 	i2cPktDir = 0;	// Packet's direction
static I2C_BUF 	*ptI2cTxBuf = 0;
static I2C_BUF 	*ptI2cRxBuf = 0;
 U8_T	 	i2cState = 0;	// I2C master state flag
 U8_T	 	i2cSlvRxPkt[SLV_MAX_PKT_NUM];
 U8_T	 	i2cSlvTxPkt[SLV_MAX_PKT_NUM];
