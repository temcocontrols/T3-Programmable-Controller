...
void UpdateIpSettings(U32_T ip)
{
	 ...
	 if(ip > 0)
	 {
		...
		IP_Addr[3] = (U8_T)(ip>>24); 		
		IP_Addr[2] = (U8_T)(ip>>16);		
		IP_Addr[1] = (U8_T)(ip>>8);		
		IP_Addr[0] = (U8_T)(ip);
	
		SUBNET[3] = (U8_T)(subnet>>24);
		SUBNET[2] = (U8_T)(subnet>>16);
		SUBNET[1] = (U8_T)(subnet>>8);
		SUBNET[0] = (U8_T)(subnet);
	
		GETWAY[3] = (U8_T)(gateWay>>24);
		GETWAY[2] = (U8_T)(gateWay>>16);
		GETWAY[1] = (U8_T)(gateWay>>8);
		GETWAY[0] = (U8_T)(gateWay);
	...
	{	
		...
		ip = (((U32_T)IP_Addr[3]) << 24) | ((U32_T)IP_Addr[2] << 16) | ((U32_T)IP_Addr[1] << 8) | (IP_Addr[0]);
		SUBNET[0] = 0;	SUBNET[1] = 255;	SUBNET[2] = 255;	SUBNET[3] = 255;
		subnet = (((U32_T)SUBNET[3]) << 24) | ((U32_T)SUBNET[2] << 16) | ((U32_T)SUBNET[1] << 8) | (SUBNET[0]);
		GETWAY[0] = 1;	GETWAY[1] = 0;	GETWAY[2] = 168;	GETWAY[3] = 192;
		gateWay = (((U32_T)GETWAY[3]) << 24) | ((U32_T)GETWAY[2] << 16) | ((U32_T)GETWAY[1] << 8) | (GETWAY[0]);
