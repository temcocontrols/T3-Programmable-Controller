...
{
	U8_T recbuf[4], ret;
    U8_T param[4] = {CMD8_PATTERN, CMD8_VHS, 0, 0};
	U32_T i = 0;
...
U8_T SD_ReadMultiBlock(U32_T startblock, U32_T blocknum, U8_T *recbuf)
{
    U32_T i;
    U8_T ret;
...
U8_T SD_WriteMultiBlock(U32_T startblock, U32_T blocknum, U8_T *sendbuf)
{
	U32_T i;
	U8_T ret,tmp[2];
...
U8_T SD_GetCardInfo(void)
{
	...
	{	
		...
		sds.block_num = (((U32_T)(csdbuf[7] & 0X3F) << 16) | ((U32_T)csdbuf[8] << 8) | csdbuf[9] + 1) << 10;			/* (C_SIZE + 1) * 512K */
