...
typedef	enum
{
	NOUSE = 0,BACNET_SLAVE,MODBUS_SLAVE,PTP_RS232_GSM,SUB_GSM,MAIN_ZIG,SUB_ZIG,MODBUS_MASTER,RS232_METER,BACNET_MASTER,
	MAX_COM_TYPE
}E_UART_TYPE;
...
extern U8_T far timezone_summer;
...
//--- other thing
  ...
  EEP_COM1_CONFIG,
	...
	EEP_NO_USED80 = 179 + USER_BASE_ADDR, // NO USED
...
//	MODUBS_BAC_LIB_REV,
	...
	MODBUS_TCP_CONNECT_NUM,
	MODBUS_UDP_CONNECT_NUM,
...
//	MODBUS_SEQUENCE,  // there are 2 ways to list INPUT struct 0 -- same as T3-4AO  1 - same as bacnet point packet
	...
	MODBUS_OUTPUT_RANGE_FIRST,  // 7294
