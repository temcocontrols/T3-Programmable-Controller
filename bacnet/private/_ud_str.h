...
typedef struct
{
	...
	U8_T reserved;//max_time;      /* the length of the monitor in time units */  
...
typedef	union
{
	...
	uint8_t en_sntp;		// 0 - no  1 - disable 2 - timeserver1, 3 - timeserver2 , 4 - timeserver3
	int time_zone;	
	uint32_t sn;
...
typedef enum { WRITE_SD_OK = 0,WAIT_FOR_SD};
