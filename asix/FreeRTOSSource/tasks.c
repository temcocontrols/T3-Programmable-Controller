...
static portSHORT data sUsingPreemption = pdFALSE;
static unsigned portSHORT data usCurrentNumberOfTasks = ( unsigned portSHORT ) 0;              
volatile portTickType data xTickCount = ( portTickType ) 0;				/* Modified by tick ISR. */
static unsigned portCHAR data ucTopUsedPriority = tskIDLE_PRIORITY;
static volatile unsigned  portCHAR data ucTopReadyPriority = tskIDLE_PRIORITY;
static signed portCHAR data cSchedulerRunning = pdFALSE;
static volatile unsigned portCHAR data ucSchedulerSuspended = pdFALSE;
static volatile unsigned portCHAR data ucMissedTicks = ( unsigned portCHAR ) 0;

/* Debugging and trace facilities private variables and macros. ------------*/


void task_initial_data(void)
{
	pxCurrentTCB = NULL;
