...
#if BBMD_ENABLED
//		dlenv_maintenance_timer(SWTIMER_INTERVAL);
#endif 
	
#if 0
	   logic_control_in_out();	 // FOR customer program
#endif 
	...
	if(Modbus.mini_type == MINI_VAV)
	{
		...
		miliseclast = miliseclast + SWTIMER_INTERVAL;
