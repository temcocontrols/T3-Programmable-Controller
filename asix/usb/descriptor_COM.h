...
/*设备描述符*/
extern const unsigned char code DevDes[];
/*配置描述符*/
extern const unsigned char code ConDes[];
/*语言描述符*/
extern const unsigned char code LangDes[];
/*厂商字符串描述符*/
extern const unsigned char code MANUFACTURER_Des[];
/*产品字符串描述符*/
extern const unsigned char code PRODUCER_Des[];
/*产品序列号字符串描述符*/
extern const unsigned char code  PRODUCER_SN_Des[];
