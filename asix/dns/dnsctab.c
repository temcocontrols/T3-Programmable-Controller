...
/*static S8_T  XDATA*/ S8_T far dnsctab_HostNameTable[DNSCTAB_MAX_RECORD][DNSCTAB_MAX_HOST_NAME_LEN + 1];
/*static U32_T XDATA*/ U32_T far dnsctab_HostIpTable[DNSCTAB_MAX_RECORD];
/*static U8_T  XDATA*/ U8_T far dnsctab_HostName[DNSCTAB_MAX_HOST_NAME_LEN + 1];
/*static U8_T  XDATA*/ U8_T far dnsctab_OldestRecord; // Oldest record for overwrite
