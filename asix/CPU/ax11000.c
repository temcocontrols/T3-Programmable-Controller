...
//	P3 = 0x00;
	...
	EXTINT0(INT_OFF);		// EINT0 interrupt.
	EXTINT1(INT_OFF);		// EINT1 interrupt.
	EXTINT2(INT_OFF);		// EINT2 interrupt for DMA request.
	EXTINT3(INT_OFF);		// EINT3 interrupt for PCA.
	EXTINT4(INT_ON);		// EINT4 interrupt for peripheral device.
	EXTINT5(INT_OFF);		// EINT5 interrupt for software timer.
	EXTINT6(INT_ON);		// EINT6 interrupt for wake-up of power management mode and stop mode.
